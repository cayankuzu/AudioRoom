...
export function createMobileControls(
  ...
  root.innerHTML = `
    ...
    <div class="mobile-controls__actions mobile-controls__actions--quantum" data-actions>
      ...
      <button type="button" class="mobile-controls__action mobile-controls__action--measure" data-key="KeyH" aria-label="Hız ölç">
        <span class="mobile-controls__action-glyph">H</span>
        <span class="mobile-controls__action-label">HIZ</span>
      </button>
      ...
      <button type="button" class="mobile-controls__action mobile-controls__action--primary" data-key="KeyE" aria-label="Al / Yerleştir">
